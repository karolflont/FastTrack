...
function Get-APSUHiddenFilesAndFoldersStatus($ComputerName,[System.Management.Automation.PSCredential] $Credential){
...
function Set-APSUHiddenFilesAndFolders($ComputerName,[System.Management.Automation.PSCredential] $Credential, [switch]$Show, [switch]$Hide){
    <#
    .SYNOPSIS
        Shows or hides hidden files and folders.
    .DESCRIPTION
        The Set-APSUHiddenFilesAndFolders function shows or hides hidden files and folders.
