...
function Get-Hostname($ComputerName,[System.Management.Automation.PSCredential] $Credential){
   <#
   .SYNOPSIS
   TODO
   .DESCRIPTION
...
.EXAMPLE
   TODO
#>
function Get-AvidPSGUserAccount($ComputerName,[System.Management.Automation.PSCredential] $Credential){
...
.EXAMPLE
   TODO
#>
function Set-AvidPSGUserAccount($ComputerName,[System.Management.Automation.PSCredential] $Credential){
